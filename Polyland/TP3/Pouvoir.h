...
public:
	...
	*/
	...
	/**
	* @brief Pour obtenir le type, qui caractérise l'effet du pouvoir
	* @return Le type, qui caractérise l'effet du pouvoir
	*/
	...
	*/
	...
	/**
	* @brief Appliquer l'effet defensif du pouvoir sur la creature passee en paramètre
	* @param nom La creature sur laquelle appliquer l'effet defensif
	*/
