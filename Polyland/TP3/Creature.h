...
public:
	...
	*/
	...
	/**
	* @brief Pour obtenir l'etat de la creature
	* @return pointeur de EtatCreature
	*/
	...
	*/
	...
	/**
	* @brief Pour modifier l'etat de la creature
	* @param etat Le nouvel etat de la creature
	*/
...
private:
	...
	/**
	* @brief Pour mettre la creature a l'etat Normal
	* 
	*/
